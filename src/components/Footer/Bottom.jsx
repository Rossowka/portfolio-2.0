  ...
  return (
    <div className="py-6 md:py-6 lg:py-8 bg-black text-f-inverse -mx-3">
      <div className="container flex flex-wrap md:items-center md:justify-between uppercase ">
        <div className="order-2  md:order-1 mt-6 md:mt-0 flex-[0_0_100%] md:max-w-[50%] border-t-[1px] border-f-inverse/20 md:border-t-0">
        ...
        <div className="order-1 md:max-w-[50%] md:order-2 md:flex md:justify-end">

...
export default function NavBarEmail({ tooltipPosition = "bottom" }) {
    ...
    <span className="relative inline-flex">
      <button
        ...
        className={[
          ...
          "font-[inherit] text-accent leading-[inherit]",
          "cursor-pointer select-none",
          // Grey at rest, full color on hover
          "text-f-tetriary hover:text-current",
          // Underline: invisible at rest, visible on hover
          "underline underline-offset-[3px] decoration-transparent hover:decoration-current",
          "transition-colors duration-200",
          // Click flash
          active ? "opacity-55" : "opacity-100",
          "focus-visible:outline focus-visible:outline-2 focus-visible:outline-current focus-visible:outline-offset-4 focus-visible:rounded-sm",
        ].join(" ")}
      >
        {EMAIL}
